  ...
  for (const z of zombies){
    ...
    if (z.kw==='angel'){
      ...
      if(z.aggro && !p.dead){
        ...
        if(z.actCd<=0){
          if(Math.random()<0.5){ z.atkT=z.atkDur; z.fired=false; z.actCd=2.6+Math.random()*1.4; }
